...
static ssize_t my_write(struct file *filp, const char __user *buffer,
                        size_t length, loff_t *offset);
static ssize_t my_read(struct file *filp, char __user *buffer, size_t length,
                       loff_t *offset);
...
static ssize_t my_read(struct file *file, char __user *buffer, size_t count,
                       loff_t *offset) {
  ...
  memmove(ff_crs_elements, ff_crs_elements + 1,
          (k_length - 1) * sizeof(ff_elem_t *));
